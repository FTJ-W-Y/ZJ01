namespace Machine
{
    ...
    public struct CavityParameter
    {
        ...
        public uint AStateVacMaxValue;            // 21)A状态真空最大值：Pa
        public uint BStateVacMaxValue;            // 22)B状态真空最大值：Pa
        public float TempDifferAlarmValue;         // 23)温差报警值：摄氏度
        public uint AStateSavePressureTime;        // 24)A状态真空保压时间：分钟
        public uint BStateSavePressureTime;        // 25)B状态真空保压时间：分钟

        public float SetTempValueEx;                // 1)设定温度：摄氏度
        public float TempUpperlimitEx;              // 2)温度上限：摄氏度
        public float TempLowerlimitEx;              // 3)温度下限：摄氏度
        public uint PreheatTimeEx;                  // 4)预热时间：分钟
        public uint VacHeatTimeEx;                  // 5)真空加热时间：分钟
        public uint OpenDoorBlowTimeEx;             // 6)开门破真空时长：分钟
        public uint OpenDoorVacPressureEx;          // 7)开门真空压力：Pa
        public uint AStateVacTimeEx;                // 8)A状态抽真空时间：分钟
        public uint AStateVacPressureEx;            // 9)A状态真空压力：Pa
        public uint BStateVacTimeEx;                // 10)B状态抽真空时间：分钟
        public uint BStateVacPressureEx;            // 11)B状态真空压力：Pa
        public uint BStateBlowAirTimeEx;            // 12)呼吸充干燥气时间：分钟
        public uint BStateBlowAirPressureEx;        // 13)呼吸充干燥气压力：Pa
        public uint BStateBlowAirKeepTimeEx;        // 14)呼吸充干燥气保持时间：分钟
        public uint BreathTimeIntervalEx;           // 15)呼吸时间间隔：分钟
        public uint BreathCycleTimesEx;             // 16)呼吸循环次数：次
        public uint HeatPlateEx;                    // 17)发热板数：块
        public uint MaxNGHeatPlateEx;               // 18)最大NG发热板数：块
        public uint HeatPreVacTimeEx;               // 19)加热前抽真空时间：分钟
        public uint HeatPreBlowEx;                  // 20)加热前充干燥气压力：Pa
        public uint VacMinValueEx;                  // 21)真空最小值：Pa
        public uint VacMaxValueEx;                  // 22)真空最大值：Pa
        public float TempDifferAlarmValueEx;         // 23)温差报警值：摄氏度
        ...
        public void Release()
        {
            ...
            this.HeatPreBlow = 0;
            this.AStateVacMaxValue = 0;
            this.BStateVacMaxValue = 0;
            this.TempDifferAlarmValue = 0;
            this.AStateSavePressureTime = 0;
            this.BStateSavePressureTime = 0;

            this.SetTempValueEx= 0;
            this.TempUpperlimitEx = 0;
            this.TempLowerlimitEx = 0;
            this.PreheatTimeEx = 0;
            this.VacHeatTimeEx = 0;
            this.OpenDoorBlowTimeEx = 0;
            this.OpenDoorVacPressureEx = 0;
            this.AStateVacTimeEx = 0;
            this.AStateVacPressureEx = 0;
            this.BStateVacTimeEx = 0;
            this.BStateVacPressureEx = 0;
            this.BStateBlowAirTimeEx = 0;
            this.BStateBlowAirPressureEx = 0;
            this.BStateBlowAirKeepTimeEx = 0;
            this.BreathTimeIntervalEx = 0;
            this.BreathCycleTimesEx = 0;
            this.HeatPlateEx = 0;
            this.MaxNGHeatPlateEx = 0;
            this.HeatPreVacTimeEx = 0;
            this.HeatPreBlowEx = 0;
            this.VacMinValueEx = 0;
            this.VacMaxValueEx = 0;
            this.TempDifferAlarmValueEx = 0;
        }
        ...
        public void Copy(CavityParameter sourceParameter)
        {
            ...
            this.AStateVacMaxValue = sourceParameter.AStateVacMaxValue;
            this.BStateVacMaxValue = sourceParameter.BStateVacMaxValue;
            this.TempDifferAlarmValue = sourceParameter.TempDifferAlarmValue;
            this.AStateSavePressureTime = sourceParameter.AStateSavePressureTime;
            this.BStateSavePressureTime = sourceParameter.BStateSavePressureTime;

            this.SetTempValueEx= sourceParameter.SetTempValueEx;
            this.TempUpperlimitEx= sourceParameter.TempUpperlimitEx;
            this.TempLowerlimitEx= sourceParameter.TempLowerlimitEx;
            this.PreheatTimeEx= sourceParameter.PreheatTimeEx;
            this.VacHeatTimeEx= sourceParameter.VacHeatTimeEx;
            this.OpenDoorBlowTimeEx= sourceParameter.OpenDoorBlowTimeEx;
            this.OpenDoorVacPressureEx= sourceParameter.OpenDoorVacPressureEx;
            this.AStateVacTimeEx= sourceParameter.AStateVacTimeEx;
            this.AStateVacPressureEx= sourceParameter.AStateVacPressureEx;
            this.BStateVacTimeEx= sourceParameter.BStateVacTimeEx;
            this.BStateVacPressureEx= sourceParameter.BStateVacPressureEx;
            this.BStateBlowAirTimeEx= sourceParameter.BStateBlowAirTimeEx;
            this.BStateBlowAirPressureEx= sourceParameter.BStateBlowAirPressureEx;
            this.BStateBlowAirKeepTimeEx= sourceParameter.BStateBlowAirKeepTimeEx;
            this.BreathTimeIntervalEx= sourceParameter.BreathTimeIntervalEx;
            this.BreathCycleTimesEx= sourceParameter.BreathCycleTimesEx;
            this.HeatPlateEx= sourceParameter.HeatPlateEx;
            this.MaxNGHeatPlateEx= sourceParameter.MaxNGHeatPlateEx;
            this.HeatPreVacTimeEx= sourceParameter.HeatPreVacTimeEx;
            this.HeatPreBlowEx= sourceParameter.HeatPreBlowEx;
            this.VacMinValueEx= sourceParameter.VacMinValueEx;
            this.VacMaxValueEx= sourceParameter.VacMaxValueEx;
            this.TempDifferAlarmValueEx= sourceParameter.TempDifferAlarmValueEx;
        }
    ...
    public class CavityData
    {
        ...
        public short alarmState;             // 报警状态：报警需复位
        #endregion
        ...
        public void Release()
        {
            ...
            this.alarmState = (short)OvenStatus.Unknown;
        ...
        public void Copy(CavityData sourceCavity)
        {
            ...
            this.alarmState = sourceCavity.alarmState;
            for (int idx0 = 0; idx0 < this.tempValue.GetLength(0); idx0++)
            {
                for(int idx1 = 0; idx1 < this.tempValue.GetLength(1); idx1++)
                {
