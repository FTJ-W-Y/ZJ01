...
namespace Machine
{
    public partial class UserLogin : Form
    {
        ...
        private void Btn_Click_Login(object sender, EventArgs e)
        {
            ...
            {
                string errMsg = "";
                this.userInfo = MachineCtrl.GetInstance().OperaterID = this.cmbUserList.SelectedItem.ToString();
                if ((null != this.cmbUserList.SelectedItem)
                    && MachineCtrl.GetInstance().dbRecord.UserLogin(this.userInfo, this.txtUserPW.Text.Trim()))
                {
                    int le = (int)MachineCtrl.GetInstance().dbRecord.UserLevel();
                    //MachineCtrl.GetInstance().dbRecord.UserLogout();
                    MachineCtrl.GetInstance().OperaterID = this.userInfo;
            ...
            {
                if (!string.IsNullOrEmpty(this.txtUserPW.Text.Trim()))
                {
        ...
        private string GetEmployeeNo(string strName)
        {
            string msg = "";
